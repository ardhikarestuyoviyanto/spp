...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Proses Pindah Dan Kenaikan Kelas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Proses Pindah Dan Kenaikan Kelas</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('admin/kenaikankelas') ?>" method="get">
                            <div class="container">
            ...
            <div class="col">
                <div class="card" style="height: 145px;"> 
                    <div class="card-body">
                    Warning ... !
                    Halaman ini digunakan untuk memindahkan siswa atau beberapa siswa dari kelas satu ke kelas lainnya jika diperlukan. Jika ada siswa yang telah dibuatkan tagihan dan dipindah kelasnya melalui halaman ini, maka tagihan tetap ada di kelas sebelumnya!
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                  <form id="kenaikankelas" method="post">
                    <table class="table table-bordered table-striped" id="PindahKelas">
                        <thead>
                            <tr>
                            <th scope="col">No</th>
                            <th scope="col">NIS</th>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                          <div class="col">
                                <div class="container">
                                  <div class="row justify-content-center">
                                  <label for="nama_alumni" class="col-sm-2 col-form-label">Proses Pindah / Naik Kelas</label>
                                    <div class="col col-sm-5 mt-2 mb-2">
                                        <select class="form-control" required name="tujuan_kelas">
                                      ...
                                      <div class="col col-sm-2 mt-2 mb-2">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="submit">Pindahkan</button>
                                      </div>
                                  </div>
                                </div>
                            </form>
...
$(document).ready(function(){
    ...
    $('#kenaikankelas').submit(function(e){
        e.preventDefault();
        $.ajax({
            url : '<?php echo base_url('Admin/kenaikankelas_action') ?>',
            type : 'POST',
            data : $(this).serialize(),
            beforeSend : function(){
                $('#spinner').show();
