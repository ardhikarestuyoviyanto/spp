...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Rekapitulasi Pembayaran Detail</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/rekap') ?>">Rekapitulasi Pembayaran</a></li>
                <li class="breadcrumb-item active">Rekapitulasi Pembayaran Detail</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
          <div class="card">
                <div class="card-header bg-primary">
                  ...
                  <a href="<?php echo base_url('admin/rekap'); ?>" type="button" style="float: right;" class="btn btn-success btn-sm active">Kembali</a>

                </div>
                <div class="card-body">
                    <form action="<?php echo base_url('export/export_rekap_det_bulanan') ?>" method="GET" target="__BLANK">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form target="__BLANK" action="<?php echo base_url('export/export_rekap_det_bebas') ?>" method="GET">
              <input type="hidden" name="rekap" value="true">
              <label for="nama_kelas" class="col-sm-2 col-form-label">Tahun Ajaran</label>
              <div class="mb-3">
                <?php if(isset($_GET['tahun'])){ ?>
